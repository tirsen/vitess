...
public class GrpcClientTlsClientAuthPkcs12Test extends RpcClientTest {
    ...
    private static void createClientConnection() throws Exception {
        final String keyStore = certDirectory.getCanonicalPath() + File.separatorChar + "client-key.p12";
