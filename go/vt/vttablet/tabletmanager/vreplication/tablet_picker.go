...
func newTabletPicker(ctxWithSpan context.Context, ts *topo.Server, cell, keyspace, shard, tabletTypesStr string) (*tabletPicker, error) {
	...
	watcher := discovery.NewShardReplicationWatcher(ctxWithSpan, ts, healthCheck, cell, keyspace, shard, *healthCheckTopologyRefresh, discovery.DefaultTopoReadConcurrency)
