...
func init() {
	...
	flag.BoolVar(&Config.AllowReadOnlyTxOnNonMaster, "queryserver-config-readonly-tx-on-non-master", DefaultQsConfig.PassthroughDMLs, "EXPERIMENTAL: allows transactions to be opened on tablets that are not master")
